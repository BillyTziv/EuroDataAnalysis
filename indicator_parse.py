                ...
                for con in content:
                    if rowLine >= 5:
                        ...
                        if country_code == search_token:
                            ...
                            indic_name = lineBuf[2]
                            indic_code = lineBuf[3]
                            ...
                            #print "Adding a indicator" + indic_name
                            Indicators[0].append(indic_name)
                            Indicators[1].append(indic_code)
...
indListSize = len(Indicators[1])
for ind in range(0, indListSize):
    print (Indicators[0][ind] + "," + Indicators[1][ind])
